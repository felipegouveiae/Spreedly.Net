using Spreedly.NetStandard.BuiltIns;
using Spreedly.NetStandard.Extensions;
using Spreedly.NetStandard.Model;
using Spreedly.NetStandard.Spreedly;
using System;
...
namespace Spreedly.NetStandard.Service
{
    public class SpreedlyService
    {
        ...
        public async Task<SupportedGatewaysResult> GetSupportedGateways()
        {
